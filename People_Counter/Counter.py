...
cap = cv2.VideoCapture(r"B:\Videos\people.mp4")
...
mask = cv2.imread(r"B:\Yolov8_Weights\mask-1.png")
...
while True:
    ...
    imgGraphics = cv2.imread(r"B:\Yolov8_Weights\graphics-1.png", cv2.IMREAD_UNCHANGED)
