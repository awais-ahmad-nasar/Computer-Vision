...
import math
from sort import *
import numpy as np  # Changed to np for consistency with imports

# cap = cv2.VideoCapture(0) # for webcam
# cap.set(3, 1280)
# cap.set(4, 720)

cap = cv2.VideoCapture("B:\Videos\cars.mp4")

model = YOLO(r"B:\Yolov8_Weights\yolov5n.pt")
...
mask = cv2.imread(r"B:\Yolov8_Weights\mask.png")
...
fourcc = cv2.VideoWriter_fourcc(*'mp4v')  # You can use other codecs such as 'XVID', 'DIVX', etc.
